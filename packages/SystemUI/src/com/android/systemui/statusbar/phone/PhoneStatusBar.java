...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    private void updateWeatherTextState(String temp, int color, int size, int font) {
        ...
        switch (font) {
            case FONT_NORMAL:
            default:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed", Typeface.NORMAL));
                break;
            case FONT_ITALIC:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed", Typeface.ITALIC));
                break;
            case FONT_BOLD:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed", Typeface.BOLD));
                break;
            case FONT_BOLD_ITALIC:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed", Typeface.BOLD_ITALIC));
                break;
            case FONT_LIGHT:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-light", Typeface.NORMAL));
                break;
            case FONT_LIGHT_ITALIC:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-light", Typeface.ITALIC));
                break;
            case FONT_THIN:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-thin", Typeface.NORMAL));
                break;
            case FONT_THIN_ITALIC:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-thin", Typeface.ITALIC));
                break;
            case FONT_CONDENSED:
                mWeatherTempView.setTypeface(Typeface.create("sans-serif-condensed", Typeface.NORMAL));
                break;
            case FONT_CONDENSED_ITALIC:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-condensed", Typeface.ITALIC));
                break;
            case FONT_CONDENSED_BOLD:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-condensed", Typeface.BOLD));
                break;
            case FONT_CONDENSED_BOLD_ITALIC:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-condensed", Typeface.BOLD_ITALIC));
                break;
            case FONT_MEDIUM:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-medium", Typeface.NORMAL));
                break;
            case FONT_MEDIUM_ITALIC:
                mWeatherTempView.setTypeface(Typeface.create("Roboto-Condensed-medium", Typeface.ITALIC));
                break;
        }
